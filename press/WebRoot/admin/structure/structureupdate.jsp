...
<s:form action="StructureAction_structureUpdate.aspx" method="post" name="frmOp" enctype="multipart/form-data">
        ...
        <tr> 
          <td align="center"><s:fielderror><s:param>cexist</s:param></s:fielderror> 
            <table width="100%" border="0" cellspacing="2" cellpadding="2">
              <tr>
				<td align="right" class="divLine" height="40">表名</td>
				<td>
				<s:textfield id="tableName" name="tableName" cssStyle="width:800px;font-size:16px;"></s:textfield>
				<s:fielderror><s:param>tableName</s:param></s:fielderror>
				</td>
			  </tr>
              <tr>
				<td align="right" class="divLine" height="40">字段名</td>
				<td>
				<s:textfield id="fieldName" name="fieldName" cssStyle="width:800px;font-size:16px;"></s:textfield>
				<s:fielderror><s:param>fieldName</s:param></s:fielderror>
				</td>
			  </tr>
			  <tr>
				<td align="right" class="divLine" height="40">中文名</td>
				<td>
				<s:textfield id="cnName" name="cnName" cssStyle="width:800px;font-size:16px;"></s:textfield>
				<s:fielderror><s:param>cnName</s:param></s:fielderror>
				</td>
			  </tr>
			  <tr>
				<td align="right" class="divLine" height="40">字段类型</td>
				<td>
				<s:select id="fieldType" name="fieldType" list="#request.C_SELECT_FIELDTYPE" listKey="value" listValue="name" cssStyle="font-size:16px"></s:select>
                <s:fielderror><s:param>fieldType</s:param></s:fielderror>
				</td>
			  </tr>
			  <tr>
				<td align="right" class="divLine" height="40">是否可用</td>
				<td>
				<s:select id="isValid" name="isValid" list="#request.C_SELECT_ISVALID" listKey="value" listValue="name" cssStyle="font-size:16px"></s:select>
                <s:fielderror><s:param>fieldType</s:param></s:fielderror>
				</td>
			  </tr>
            </table>
