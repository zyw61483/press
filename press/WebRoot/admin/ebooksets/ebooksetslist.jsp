		...
		<td height="32" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="bottom" background="/adminimages/main_title_bag.gif" class="main_title">资源系列管理</td>
	    ...
	    <td height="30" background="/adminimages/m_box_title.gif" class="main_box_opt">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td class="icon_add"><a href="javascript:ebooksetsNew()" class="menu">添加</a></td>
					<td class="icon_del"><a href="javascript:ebooksetsDelete(document.forms[0],'ids')" class="menu">删除</a></td>
					<td class="icon_sea"><a href="javascript:ebooksetsSearch()" class="menu">高级搜索</a></td>
    	...
    	<td class="main_box" align="center" valign="top" style="padding: 4px 4px 4px 4px">
	    	...
	    	<table border="1" width="100%" cellpadding="2" cellspacing="0" class="tableMainDetail">
	    		<tr>
			        ...
			        <td class="table_title" align="center"><evr:sort_title cnName="系列名" sortStr="${request.C_PAGE_SORT}" fieldName="item"/></td>
			        <td class="table_title" align="center"><evr:sort_title cnName="类别" sortStr="${request.C_PAGE_SORT}" fieldName="type"/></td>
			        <td class="table_title"><evr:sort_title cnName="排序号" sortStr="${request.C_PAGE_SORT}" fieldName="seq"/></td>
				...
				<tr onmouseover="this.style.background='#FDFAC5'" onmouseout="this.style.background=''">
		      		...
		      		<td class="table_list"><s:property value="item"/></td>
		      		<td class="table_list"><s:property value="type"/></td>
			        <td class="table_list"><s:property value="seq"/></td>
			        <td class="table_list" align="center" onclick="ebooksetsUpdate('<s:property value="id"/>')"><img src="/adminimages/icon_modify.gif" style="cursor:hand"></td>
			    </tr>
		      	</s:iterator>
				</s:if>
	    	</table>
