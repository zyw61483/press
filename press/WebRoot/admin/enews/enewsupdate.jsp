...
<s:form action="EnewsAction_enewsUpdate.aspx" method="post" name="frmOp" enctype="multipart/form-data">
          ...
          <td align="center"><s:fielderror><s:param>cexist</s:param></s:fielderror> 
            <table width="100%" border="0" cellspacing="2" cellpadding="2">
              ...
              <tr>
				...
				<td>
				<s:file id="image" name="image" cssStyle="width:800px;font-size:16px;" contenteditable="false"></s:file>
	            <s:fielderror><s:param>image</s:param></s:fielderror>
				</td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				<td align="right" class="divLine" height="40">置顶数</td>
				<td>
				<s:textfield id="browse" name="browse" cssStyle="width:800px;font-size:16px;" onkeyup="this.value=getNum(this.value)"></s:textfield>
				<s:fielderror><s:param>browse</s:param></s:fielderror>
				</td>
			  </tr>
			  <tr>
