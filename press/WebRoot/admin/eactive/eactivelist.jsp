		...
		<td height="32" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="bottom" background="/adminimages/main_title_bag.gif" class="main_title">用户参加活动记录</td>
	    ...
	    <td height="30" background="/adminimages/m_box_title.gif" class="main_box_opt">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td class="icon_add"><a href="javascript:eactiveNew()" class="menu">添加</a></td>
					<td class="icon_del"><a href="javascript:eactiveDelete(document.forms[0],'ids')" class="menu">删除</a></td>
					<td class="icon_sea"><a href="javascript:eactiveSearch()" class="menu">高级搜索</a></td>
    	...
    	<td class="main_box" align="center" valign="top" style="padding: 4px 4px 4px 4px">
	    	...
	    	<table border="1" width="100%" cellpadding="2" cellspacing="0" class="tableMainDetail">
	    		<tr>
			        ...
			        <td class="table_title" align="center"><evr:sort_title cnName="参加活动用户" sortStr="${request.C_PAGE_SORT}" fieldName="name"/></td>
			        <td class="table_title"><evr:sort_title cnName="用户姓名" sortStr="${request.C_PAGE_SORT}" fieldName="realname"/></td>
			        <td class="table_title" ><evr:sort_title cnName="用户地址" sortStr="${request.C_PAGE_SORT}" fieldName="address"/></td>
			        <td class="table_title" ><evr:sort_title cnName="活动编号" sortStr="${request.C_PAGE_SORT}" fieldName="code"/></td>
			        <td class="table_title" ><evr:sort_title cnName="参加活动时间" sortStr="${request.C_PAGE_SORT}" fieldName="time"/></td>
				...
				<tr onmouseover="this.style.background='#FDFAC5'" onmouseout="this.style.background=''">
			        ...
			        <td class="table_list"><s:property value="address"/></td>
			        <td class="table_list"><s:property value="code"/></td>
			        <td class="table_list"><s:property value="time"/></td>
			        <td class="table_list" align="center" onclick="eactiveUpdate('<s:property value="id"/>')"><img src="/adminimages/icon_modify.gif" style="cursor:hand"></td>
			    </tr>
		      	</s:iterator>
				</s:if>
	    	</table>
