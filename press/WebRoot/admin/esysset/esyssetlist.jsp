		...
		<td height="32" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="bottom" background="/adminimages/main_title_bag.gif" class="main_title">系数设置</td>
	    ...
	    <td height="30" background="/adminimages/m_box_title.gif" class="main_box_opt">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td class="icon_add"><a href="javascript:esyssetNew()" class="menu">添加</a></td>
					<td class="icon_del"><a href="javascript:esyssetDelete(document.forms[0],'ids')" class="menu">删除</a></td>
					<td class="icon_sea"><a href="javascript:esyssetSearch()" class="menu">高级搜索</a></td>
    	...
    	<td class="main_box" align="center" valign="top" style="padding: 4px 4px 4px 4px">
	    	...
	    	<table border="1" width="100%" cellpadding="2" cellspacing="0" class="tableMainDetail">
	    		<tr>
			        ...
			        <td class="table_title" align="center"><evr:sort_title cnName="系数名" sortStr="${request.C_PAGE_SORT}" fieldName="item"/></td>
			        <td class="table_title"><evr:sort_title cnName="系数" sortStr="${request.C_PAGE_SORT}" fieldName="factor"/></td>
				...
				<tr onmouseover="this.style.background='#FDFAC5'" onmouseout="this.style.background=''">
		      		...
		      		<td class="table_list"><s:property value="factor"/></td>
			        <td class="table_list" align="center" onclick="esyssetUpdate('<s:property value="id"/>')"><img src="/adminimages/icon_modify.gif" style="cursor:hand"></td>
			    </tr>
		      	</s:iterator>
				</s:if>
	    	</table>
