...
<s:form action="EsyssetAction_esyssetUpdate.aspx" method="post" name="frmOp" enctype="multipart/form-data">
          ...
          <td align="center"><s:fielderror><s:param>cexist</s:param></s:fielderror> 
            <table width="100%" border="0" cellspacing="2" cellpadding="2">
              ...
              <tr>
				...
				<td>
				<s:textfield id="factor" name="factor" cssStyle="width:800px;font-size:16px;"></s:textfield>
