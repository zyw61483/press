...
<s:form action="EsyssetAction_esyssetAdd.aspx" method="post" name="frmOp" enctype="multipart/form-data">
        ...
        <tr> 
          <td align="center"><s:fielderror><s:param>cexist</s:param></s:fielderror> 
            <table width="100%" border="0" cellspacing="2" cellpadding="2">
              <tr>
				<td align="right" class="divLine" height="40">系数名</td>
				<td>
              ...
              <tr>
				<td align="right" class="divLine" height="40">系数</td>
				<td>
				<s:textfield id="factor" name="factor" cssStyle="width:800px;font-size:16px;" onkeyup="this.value=getNum(this.value)"></s:textfield>
				<s:fielderror><s:param>factor</s:param></s:fielderror>
				</td>
			  </tr>
            </table>
          </td>
