...
<s:form action="EsysuserAction_esysuserModpw.aspx" method="post" name="frmOp">
        ...
        <tr> 
          <td align="center"><s:fielderror><s:param>cexist</s:param></s:fielderror> 
            <table width="100%" border="0" cellspacing="2" cellpadding="2">
              <tr>
				<td align="right" class="divLine" height="100">新密码</td>
				<td>
				<s:password id="password" name="password" cssStyle="width:800px;font-size:16px;"></s:password>
