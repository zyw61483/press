...
<body onload="resizeFormStatus()">
	<s:form action="ErollAction_erollUpdate.aspx" method="post"
		name="frmOp" enctype="multipart/form-data">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<td><s:file id="image" name="image"
									cssStyle="width:800px;font-size:16px;" contenteditable="false"></s:file>
								<s:fielderror>
						...
						<tr>
							...
							<td><s:select id="type" name="type"
									list="#request.C_SELECT_TYPE" listKey="value" listValue="name"
									cssStyle="font-size:16px"></s:select> <s:fielderror>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td width="100" align="center"><input type="button"
							value='关闭窗口' class="mybutton" title='关闭窗口' onClick="closeForm()">
						</td>
						<td>&nbsp;</td>
					</tr>
				</table>
