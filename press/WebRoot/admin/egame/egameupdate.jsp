...
<s:form action="EgameAction_egameUpdate.aspx" method="post" name="frmOp" enctype="multipart/form-data">
	      ...
	      <tr> 
	          <td align="center"><s:fielderror><s:param>cexist</s:param></s:fielderror> 
	            <table width="100%" border="0" cellspacing="2" cellpadding="2">
	              <tr>
				<td align="right" class="divLine" height="40">参与游戏用户</td>
				<td>
              ...
              <tr>
				<td align="right" class="divLine" height="40">参与时间</td>
				<td>
			  ...
			  <tr>
				<td align="right" class="divLine" height="40">游戏分数</td>
				<td>
				<s:textfield id="score" name="score" cssStyle="width:800px;font-size:16px;" contenteditable="false"></s:textfield>
	            <s:fielderror><s:param>score</s:param></s:fielderror>
				</td>
			  </tr>
			  <tr>
				<td align="right" class="divLine" height="40">时长</td>
				<td>
				<s:textfield id="duration" name="duration" cssStyle="width:800px;font-size:16px;" contenteditable="false"></s:textfield>
	            <s:fielderror><s:param>duration</s:param></s:fielderror>
				</td>
			  </tr>
	            </table>
	          </td>
