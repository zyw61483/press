		...
		<td height="32" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="bottom" background="/adminimages/main_title_bag.gif" class="main_title">资源管理</td>
	    ...
	    <td height="30" background="/adminimages/m_box_title.gif" class="main_box_opt">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td class="icon_add"><a href="javascript:ebookNew()" class="menu">添加</a></td>
					<td class="icon_del"><a href="javascript:ebookDelete(document.forms[0],'ids')" class="menu">删除</a></td>
					<td class="icon_sea"><a href="javascript:ebookSearch()" class="menu">高级搜索</a></td>
    	...
    	<td class="main_box" align="center" valign="top" style="padding: 4px 4px 4px 4px">
	    	...
	    	<table border="1" width="100%" cellpadding="2" cellspacing="0" class="tableMainDetail">
	    		<tr>
			        ...
			        <td class="table_title" ><evr:sort_title cnName="资源文件" sortStr="${request.C_PAGE_SORT}" fieldName="resfile"/></td>
			        <td class="table_title" ><evr:sort_title cnName="作者" sortStr="${request.C_PAGE_SORT}" fieldName="author"/></td>
			        <td class="table_title" ><evr:sort_title cnName="出版社" sortStr="${request.C_PAGE_SORT}" fieldName="publisher"/></td>
			        <td class="table_title" ><evr:sort_title cnName="出版时间" sortStr="${request.C_PAGE_SORT}" fieldName="publishtime"/></td>
			        <td class="table_title" ><evr:sort_title cnName="类别" sortStr="${request.C_PAGE_SORT}" fieldName="type"/></td>
			        <td class="table_title" ><evr:sort_title cnName="系列" sortStr="${request.C_PAGE_SORT}" fieldName="sets"/></td>
			        ...
			        <td class="table_title" ><evr:sort_title cnName="置顶" sortStr="${request.C_PAGE_SORT}" fieldName="flag"/></td>
			        <td class="table_title" ><evr:sort_title cnName="浏览次数" sortStr="${request.C_PAGE_SORT}" fieldName="browse"/></td>
				...
				<tr onmouseover="this.style.background='#FDFAC5'" onmouseout="this.style.background=''">
			        ...
			        <td class="table_list" onDblClick="searchServer('EbookAction_getInfo.aspx?id=<s:property value="id"/>','_DetailInfo')" style="cursor:hand" align="center"><< 双击查看 >></td>
		      		<td class="table_list"><s:property value="resfile"/></td>
		      		<td class="table_list"><s:property value="author"/></td>
			        <td class="table_list"><s:property value="publisher"/></td>
			        <td class="table_list"><s:property value="publishtime"/></td>
			        <td class="table_list"><s:property value="type"/></td>
			        <td class="table_list"><s:property value="sets"/></td>
			        <td class="table_list"><s:property value="name"/></td>
			        <td class="table_list"><s:property value="time"/></td>
			        <td class="table_list"><s:property value="flag"/></td>
			        <td class="table_list"><s:property value="browse"/></td>
			        <td class="table_list" align="center" onclick="ebookUpdate('<s:property value="id"/>')"><img src="/adminimages/icon_modify.gif" style="cursor:hand"></td>
			    </tr>
		      	</s:iterator>
				</s:if>
	    	</table>
